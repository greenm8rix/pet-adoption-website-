...
<html xlms = "http://www.w3.org/1999/xhtml" lang = "en">
 ...
 <?php include('header.php'); ?>
	...
	if (empty($_POST['about'])) { 
		...
		{      
			$sql = "INSERT INTO dog(firstname,lastname,email,breed,age,gender,childFriendly,about) VALUES(?,?,?,?,?,?,?,?)";
        ...
        <div class = "sideMenu">
            <ul>
                ...
                <li id = "unactive"> <a href = "dogCare.php">Cat Care</a></li>
		...
		<div class = "content">
            ...
            <form id = "form" method="post"   action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> " enctype=”multipart/form-data” >
              <h1 class = "label">Adoption form</h1>
                 <hr>
